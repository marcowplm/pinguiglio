...
(cl:in-package rosserial_r2p-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <Test-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosserial_r2p-srv:<Test-request> is deprecated: use rosserial_r2p-srv:Test-request instead.")))

(cl:ensure-generic-function 'input-val :lambda-list '(m))
(cl:defmethod input-val ((m <Test-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosserial_r2p-srv:input-val is deprecated.  Use rosserial_r2p-srv:input instead.")
  (input m))
...
(cl:defmethod cl:initialize-instance :after ((m <Test-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosserial_r2p-srv:<Test-response> is deprecated: use rosserial_r2p-srv:Test-response instead.")))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <Test-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosserial_r2p-srv:output-val is deprecated.  Use rosserial_r2p-srv:output instead.")
  (output m))
