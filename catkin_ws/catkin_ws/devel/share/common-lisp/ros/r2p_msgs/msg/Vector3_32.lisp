...
(cl:defmethod cl:initialize-instance :after ((m <Vector3_32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3_32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name r2p_msgs-msg:<Vector3_32> is deprecated: use r2p_msgs-msg:Vector3_32 instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Vector3_32>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2p_msgs-msg:x-val is deprecated.  Use r2p_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Vector3_32>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2p_msgs-msg:y-val is deprecated.  Use r2p_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Vector3_32>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader r2p_msgs-msg:z-val is deprecated.  Use r2p_msgs-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vector3_32>)))
  ...
  (cl:format cl:nil "# This represents a vector in free space (32 bit variant). ~%~%float32 x~%float32 y~%float32 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vector3_32)))
  "Returns full string definition for message of type 'Vector3_32"
  (cl:format cl:nil "# This represents a vector in free space (32 bit variant). ~%~%float32 x~%float32 y~%float32 z~%~%~%"))
