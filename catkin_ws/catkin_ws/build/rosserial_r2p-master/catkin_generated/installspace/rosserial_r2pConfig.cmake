...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_r2p' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/install/${idir}'.  Ask the maintainer 'Martino Migliavacca <martino.migliavacca@gmail.com>, Ludovico Russo <ludus.russo@gmail.com>' to fix it.")
    endif()
